...
``` r
# Join two dataset use left join
Five_Thirty_Eight =
  left_join(pols_month, snp, by = c("year","month")) %>% 
# Join the third dataset use left join
...
## # … with 1,216 more rows, and 1 more variable: unemployment_rate <dbl>
## # ℹ Use `print(n = ...)` to see more rows, and `colnames()` to see all variable names
```
...
##       year         month            president            gov_gop     
##  Min.   :1947   Length:1226        Length:1226        Min.   :12.00  
##  1st Qu.:1971   Class :character   Class :character   1st Qu.:18.00  
##  Median :1985   Mode  :character   Mode  :character   Median :22.00  
##  Mean   :1984                                         Mean   :22.78  
##  3rd Qu.:2000                                         3rd Qu.:29.00  
##  Max.   :2015                                         Max.   :34.00  
##                                                                      
##     sen_gop        rep_gop         gov_dem         sen_dem         rep_dem     
##  Min.   :32.0   Min.   :141.0   Min.   :17.00   Min.   :44.00   Min.   :188.0  
##  1st Qu.:43.0   1st Qu.:176.0   1st Qu.:22.00   1st Qu.:48.00   1st Qu.:210.0  
##  Median :46.0   Median :195.0   Median :28.00   Median :53.00   Median :250.0  
##  Mean   :46.6   Mean   :195.4   Mean   :27.03   Mean   :53.77   Mean   :243.5  
##  3rd Qu.:53.0   3rd Qu.:223.0   3rd Qu.:32.00   3rd Qu.:58.00   3rd Qu.:264.0  
##  Max.   :56.0   Max.   :253.0   Max.   :41.00   Max.   :71.00   Max.   :301.0  
##                                                                                
##      close         unemployment_rate
##  Min.   :  63.54   Min.   : 2.500   
##  1st Qu.: 115.14   1st Qu.: 4.900   
##  Median : 414.03   Median : 5.700   
##  Mean   : 645.91   Mean   : 5.985   
##  3rd Qu.:1147.73   3rd Qu.: 7.200   
##  Max.   :2107.39   Max.   :10.800   
##  NA's   :667       NA's   :12
```
